    ...
    def _get_default_mcp_config(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            "math": {
                ...
                "url": f"http://{os.getenv('MCP_HOST', 'localhost')}:{os.getenv('MATH_HTTP_PORT', '8000')}/mcp",
            },
            "stock_local": {
                "transport": "streamable_http",
                "url": f"http://{os.getenv('MCP_HOST', 'localhost')}:{os.getenv('GETPRICE_HTTP_PORT', '8003')}/mcp",
            },
            "search": {
                "transport": "streamable_http",
                "url": f"http://{os.getenv('MCP_HOST', 'localhost')}:{os.getenv('SEARCH_HTTP_PORT', '8004')}/mcp",
            },
            "trade": {
                "transport": "streamable_http",
                "url": f"http://{os.getenv('MCP_HOST', 'localhost')}:{os.getenv('TRADE_HTTP_PORT', '8002')}/mcp",
            },
        }
